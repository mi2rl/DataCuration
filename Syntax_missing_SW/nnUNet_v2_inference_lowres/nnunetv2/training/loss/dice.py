...
class SoftDiceLoss(nn.Module):
    print("training.loss.dice.SoftDiceLoss")
    def __init__(self, apply_nonlin: Callable = None, batch_dice: bool = False, do_bg: bool = True, smooth: float = 1.,
                 ddp: bool = True, clip_tp: float = None, alpha=0.3):
...
class MemoryEfficientSoftDiceLoss(nn.Module):
    print("training.loss.dice.MemoryEfficientSoftDiceLoss")
    def __init__(self, apply_nonlin: Callable = None, batch_dice: bool = False, do_bg: bool = True, smooth: float = 1.,
                 ddp: bool = True, alpha=0.5):
        """
        ...
        self.ddp = ddp
        self.alpha = alpha
        self.focal_loss = FocalLoss()  # Add this line
