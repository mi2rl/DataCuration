...
class nnUNetTrainerCELoss(nnUNetTrainer):
    print("nnunetv2.training.nnUNetTrainer.variants.loss.nnUNetTrainerCELoss.nnUNetTrainerCELoss")
...
class nnUNetTrainerCELoss_5epochs(nnUNetTrainerCELoss):
    print("nnunetv2.training.nnUNetTrainer.variants.loss.nnUNetTrainerCELoss.nnUNetTrainerCELoss_5epochs")
