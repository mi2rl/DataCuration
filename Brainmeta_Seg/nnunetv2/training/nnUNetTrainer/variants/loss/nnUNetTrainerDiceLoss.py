...
class nnUNetTrainerDiceLoss(nnUNetTrainer):
    print("nnunetv2.training.nnUNetTrainer.variants.loss.nnUNetTrainerDiceLoss.nnUNetTrainerDiceLoss")
...
class nnUNetTrainerDiceCELoss_noSmooth(nnUNetTrainer):
    print("nnunetv2.training.nnUNetTrainer.variants.loss.nnUNetTrainerDiceLoss.nnUNetTrainerDiceCELoss_noSmooth")
    def _build_loss(self):
        # set smooth to 0
